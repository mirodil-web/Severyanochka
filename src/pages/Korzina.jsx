    ...
    <div className='pb-20 bg-[#F3F2F1]'>
      <div className="container">
        ...
        <div className='flex mb-7' >
          ...
          <button className='text-red-600'>Удалить выбранные</button>
        </div>
        ...
        <svg className='w-80' viewBox="656 573 264 182" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns: xlink="http://www.w3.org/1999/xlink">
