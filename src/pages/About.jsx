  ...
  return (
      <section className=''>
          <div className="container">
              ...
              <div className='p-8 relative flex flex-col pt-10 pb-16'>
                  ...
                  <img className='md:absolute right-10 bottom-16' src={Group} alt="Odamlar" />

                  
              </div>

              <ul className='grid grid-cols-1 md:grid-cols-3 justify-between  py-14'>
