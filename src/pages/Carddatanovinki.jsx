...
const Carddatanovinki = () => {

    const { id } = useParams()

  const data = novinkidata.find(e => e.id === parseInt(id))
      ...
      <div className='bg-[#FBF8EC]'>
        <div className="container">
          ...
          <div className='flex justify-between pb-14'>
            ...
            <div className='mr-10 bg-white rounded-nor pt-14 px-10 flex flex-col  shadow-md'>
        ...
        <section className='py-14'>
          <div className="container">
            ...
            <div className='py-5'>
              ...
              <textarea cols="30" rows="7" className='border border-yellow-500/50 px-4 py-2 rounded-nor mb-4 w-full' placeholder='Отзыв'></textarea>
...
export default Carddatanovinki